return {
	-- lspconfig
	{
		...
		opts = {
			...
			-- `bufnr` and `filter` is handled by the DodiVim formatter,
		...
		config = function(_, opts)
			-- setup autoformat
			require("dodi.plugins.lsp.format").autoformat = opts.autoformat
			-- setup formatting and keymaps
			require("dodi.util").on_attach(function(client, buffer)
				require("dodi.plugins.lsp.format").on_attach(client, buffer)
